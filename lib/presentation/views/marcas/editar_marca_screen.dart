...
class EditarMarcaScreen extends StatefulWidget {
  final String id;
  const EditarMarcaScreen({super.key, required this.id});

  @override
  State<EditarMarcaScreen> createState() => _EditarMarcaScreenState();
}

class _EditarMarcaScreenState extends State<EditarMarcaScreen> {
  String? result;
  String? categoria;
  //datos del producto
  String? nombre;
  ...
  void initState() {
    ...
    marcas = dataCubit.state.marcas ?? [];
    final marca =
        marcas!.firstWhere((element) => element.id.toString() == widget.id);
    marcaWidget = marca;
     marca.imagen == '' ? imagepath = "https://upload.wikimedia.org/wikipedia/commons/1/14/No_Image_Available.jpg" :imagepath = marca.imagen;
    print(imagepath);
    // Asignar valores a los controladores
    _nombreController.text = marca.nombre;
    imagepathAnterior = marca.imagen ?? '';
    nombre = marca.nombre;
  }
                      ...
                      SizedBox(
                        ...
                        child: SizedBox(
                          ...
                          child: InputSugestion(
                            ...
                            valorInicial: marcaWidget?.nombre,
                            marcas: marcas,
                                   ...
                                   final Directory baseDir =
                                          ...
                                          if(imagepathAnterior == ''){
                                            ...
                                            setState(() {
                                              ...
                                              if (imagepath != null && imagepath != imagepathAnterior && imagepath != ''){
