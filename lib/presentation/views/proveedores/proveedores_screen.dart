      ...
      floatingActionButton: ExpandableFab(
        ...
        children: [
          ActionButton(
           ...
           ActionButton(
            onPressed: () => context.push('/proveedores/crearproveedor/'),
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      TextButton(
                          onPressed: () {}, child: const Text('Proveedores')),
                      TextButton(
...
class _ProveedoresContainer extends StatelessWidget {
  const _ProveedoresContainer();
                ...
                child: Wrap(
                  ...
                  children: proveedores
                      .map((producto) => SizedBox(
                            ...
                            child: _ProveedorListCard(proveedor: producto),
                          ))
                      .toList(),
                ),
              ),
...
class _ProveedorListCard extends StatelessWidget {
  final Proveedor proveedor;
  const _ProveedorListCard({required this.proveedor});
      ...
      child: Column( 
        ...
        children: [
          Padding(
            ...
            child: Image(
              image: proveedor.imagen != "" && File(proveedor.imagen).existsSync()
                                      ? FileImage(File(proveedor.imagen)) 
          ...
          Text(proveedor.nombre,
            ...
            Row(
              ...
              children: [
                FilledButton(onPressed: (){  context.push('/proveedores/editarproveedor/${proveedor.id}');}, child: const Text('Editar')),
    
                FilledButton(onPressed: ()async{
                  final (success,data) = await dataCubit.deleteProveedor( proveedor.id!);
                  proveedor.imagen != "" ? File(proveedor.imagen).deleteSync() : null;
                  if(success == true ){
